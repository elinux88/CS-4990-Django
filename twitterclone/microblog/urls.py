...
urlpatterns = [
    ...
    url(r'^profile/(?P<pk>\d+)/edit/$', login_required(views.ProfileUpdateView.as_view()), name="updateprofile"),
    ...
    url(r'^newpost/$', login_required(views.CreatePostView.as_view()), name="addpost"),
]
