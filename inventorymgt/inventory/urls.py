...
urlpatterns = [
   ...
   url(r'^category/(?P<pk>[0-9]+)/delete/$', views.DeleteCategoryView.as_view(), name="categorydeletesuccess"),
   ...
   url(r'^item/delete/success/$', TemplateView.as_view(template_name="inventory/item_delete_success.html"), name="itemdeletesuccess"),
]
